 ...
 * @param {string} data
 * @returns {"complete" | "incomplete" | "not-escape"}
 */
...
/**
 * @param {string} buffer
 * @returns {{ sequences: string[]; remainder: string }}
 */
...
/**
 * @typedef {object} StdinBufferOptions
 * @property {number} [timeout] Maximum time to wait for sequence completion (default: 10ms). After this time, the buffer is flushed even if incomplete
 */

/**
 * @typedef {{ data: [string]; paste: [string] }} StdinBufferEventMap
 */
...
export class StdinBuffer extends EventEmitter {
	...
	/** @param {StdinBufferOptions} [options] */
	constructor(options = {}) {
		super();
