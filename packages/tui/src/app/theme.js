...
//   - Token-based palette (`theme.fg("chromeAccent", s)`, `theme.bg("userMessageBg", s)`)
...
const FG = {
	...
	transcriptAccent: TRANSCRIPT_ACCENT,
	// Back-compatibility alias for older app code. New code should pick a semantic token instead of the generic accent name.
	...
	toolOutput: "#737373",
	mdHeading: "#f0c674",
	mdLink: TRANSCRIPT_ACCENT,
	mdCode: TRANSCRIPT_ACCENT,
	mdCodeBlock: "#b5bd68",
	mdCodeBlockBorder: "#808080",
	mdQuote: "#808080",
	mdQuoteBorder: "#808080",
	mdHr: "#808080",
	mdListBullet: TRANSCRIPT_ACCENT,
}

/** @type {Record<string, string | number>} */
const BG = {
	selectedBg: "#3a3a4a",
	hiddenSessionBg: "#24242c",
