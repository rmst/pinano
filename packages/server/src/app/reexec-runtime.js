...
export const REEXEC_REQUEST_FILE_ENV = "PINANO_REEXEC_REQUEST_FILE"
export const REEXEC_SUPERVISOR_PID_ENV = "PINANO_REEXEC_SUPERVISOR_PID"
...
/**
 * Run a small foreground supervisor that owns restart requests for one interactive Pinano client.
...
/**
 * Reopen the current Pinano runtime without building a stale parent chain. Launcher-owned supervisors are preferred; direct runtime invocations fall back to supervision inside the stale process.
 * @param {{ command: string, args: string[], cwd?: string, env?: NodeJS.ProcessEnv, envPatch?: Record<string, string | number | boolean | null | undefined> }} options
 */
