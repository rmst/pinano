...
const DEFAULT_BASE_INSTRUCTIONS_PREFIX = dedent`
	You are an expert coding assistant operating inside pinano, a coding agent harness. You help users by reading files, executing commands, editing code, and writing new files.`
