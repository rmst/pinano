...
import { configuredServiceToken } from "./service-config.js"
...
async function createGeneratedServiceToken(path) {
	...
	try {
		...
		throw new Error(`Generated Pinano service token file exists but does not contain a valid token: ${path}`)
	}
}
