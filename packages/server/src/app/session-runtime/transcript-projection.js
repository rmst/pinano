...
import { projectMaintenanceMessage } from "../session-context.js"
...
export function projectVisibleMessage(message, options = {}) {
	...
	if (options.showAutomatedMaintenanceUsers === true && message.role === "user") {
		const projected = { ...message, pinanoMaintenanceAudit: true }
	...
	return projected.role === "assistant" ? { ...projected, pinanoMaintenanceAudit: true } : projected
}
