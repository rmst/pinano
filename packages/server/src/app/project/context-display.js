import { LAZY_NOTICE_HEADING } from "../context/lazy.js"
import { isProjectContextMessage, PROJECT_CONTEXT_HEADING } from "./context.js"
 ...
 * text that follows one of Cerex's context headings, so ordinary markdown in
