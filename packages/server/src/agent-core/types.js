 ...
 * @property {(result: AgentToolResult<any>) => unknown} projectResult
 */
 ...
 * @property {(context: { context: AgentContext, newMessages: AgentMessage[] }) => AgentMessage[] | Promise<AgentMessage[]>} [getPreTurnMessages]
 * @property {(context: ShouldStopAfterTurnContext) => AgentMessage[] | undefined | Promise<AgentMessage[] | undefined>} [projectMessagesForNextAction]
 ...
 * @property {(context: ShouldStopBeforeToolCallsContext) => number | undefined | Promise<number | undefined>} [maxToolCalls]
 */
