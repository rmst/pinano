export const WEB_PRODUCT_NAME = "Cerex"
export const WEB_PRODUCT_SHORT_NAME = "Cerex"
...
export const CEREX_LOGO_MARK_CC16_PATH = "/assets/brand/cerex-logo-mark-cc16.png"
export const CEREX_FAVICON_PATH = "/assets/brand/cerex-favicon.png"
export const CEREX_MACOS_STATUS_ICON_PATH = "/assets/brand/cerex-macos-status-icon.png"
export const WEB_APP_ICON_VERSION = "cerex-4"
export const WEB_APP_ICON_HREF = `${WEB_APP_ICON_PATH}?v=${WEB_APP_ICON_VERSION}`
export const WEB_APP_PWA_ICON_PATH = CEREX_LOGO_MARK_CC16_PATH
...
export const WEB_APP_FAVICON_PATH = CEREX_FAVICON_PATH
