...
export class LazyContextLoader {
	 ...
	 */
	hydrateFromMessages(messages: ReadonlyArray<any>): void {
	 ...
	 */
	loadForPath(path: string): ContextFile[] {
 ...
 */
export function formatLazyContextNotice(files: ContextFile[]): string {
...
export function extractToolPath(toolName: string, args: any): string | null {
