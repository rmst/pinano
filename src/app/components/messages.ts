...
import { Box, Container, Spacer, Text } from "../../tui/index.ts"
import { theme } from "../theme.ts"
import { formatToolCall } from "./tool-format.ts"
...
function userText(message: AnyMessage): string {
...
export class UserMessageComponent extends Container {
	constructor(message: AnyMessage | string) {
		super()
...
export class AssistantMessageComponent extends Container {
	...
	constructor(message?: AnyMessage) {
		super()
	...
	update(message: AnyMessage): void {
		...
		const hasToolCalls = blocks.some((b: any) => b.type === "toolCall")
...
function formatArgsJson(args: any): string {
...
export class ToolExecutionComponent extends Container {
	...
	getState(): "pending" | "success" | "error" {
		return this.state
	}
}
...
export class CustomMessageComponent extends Container {
	constructor(text: string, opts: { label?: string; tone?: "info" | "warn" | "error" } = {}) {
		super()
