 ...
 * @param {string} cwd
 * @param {{ executeTool: (name: string, id: string, args: any, signal?: AbortSignal, onUpdate?: (update: any) => void, options?: { scope?: any, toolProfile?: "default" | "apply_patch" }) => Promise<any> }} executor
 * @param {{ getScope?: () => any, toolProfile?: "default" | "apply_patch" }} [options]
 */
