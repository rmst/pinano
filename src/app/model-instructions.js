// Model-specific instructions adapted from Codex model_messages.instructions_template
// entries in inspiration/codex/codex-rs/models-manager/models.json. Keep Pinano
// harness differences here instead of bloating the global prompt for every model.
...
- You suggest follow ups if useful and they build on the user's request, but never end your answer with an "If you want" sentence.
...
export const GPT_5_4_MINI_PINANO_INSTRUCTIONS = [
	`You are an expert coding assistant operating inside Pinano, a coding agent harness using GPT-5.4 mini. You and the user share one workspace and collaborate to achieve the user's goals.
...
Concrete tool capabilities and argument contracts are supplied separately through Pinano's model API tool definitions.
...
You communicate with the user through Pinano. You have two channels:
...
/** @param {{ baseInstructionsKey?: string, baseInstructions?: string } | undefined} model */
