...
import { pickRewindMessage } from "../components/user-message-selector.js"
...
export const forkCommand = {
	...
	handler: async (ctx) => {
		...
		/** @type {string | null} */
		const newLeafId = chosenEntry?.parentId ?? null
		...
		const idx = oldBranch.findIndex((e) => e.id === chosenId)
...
export function registerBranchingCommands(registry) {
