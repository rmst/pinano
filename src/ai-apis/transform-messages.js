...
// is converted to OpenAI Chat Completions format:
//   1. If the model has no image input, replace image blocks with a
//      placeholder text block.
//   2. If a previous assistant turn had tool calls but no matching tool
...
export function transformMessages(messages, model) {
	const downgraded = downgradeImages(messages, model)
