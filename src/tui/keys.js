 ...
 * Originally a template-literal type providing autocomplete narrowing;
 * collapsed to plain string for JSDoc.
 ...
 * @typedef {"press" | "repeat" | "release"} KeyEventType
 */

/**
 * @typedef {object} ParsedKittySequence
 * @property {number} codepoint
 * @property {number} [shiftedKey] Shifted version of the key (when shift is pressed)
 * @property {number} [baseLayoutKey] Key in standard PC-101 layout (for non-Latin layouts)
 * @property {number} modifier
 * @property {KeyEventType} eventType
 */

/**
 * @typedef {object} ParsedModifyOtherKeysSequence
 * @property {number} codepoint
 * @property {number} modifier
 */
...
/** @typedef {keyof typeof LEGACY_SHIFT_SEQUENCES} LegacyModifierKey */
...
/**
 * @param {string | undefined} eventTypeStr
 * @returns {KeyEventType}
 */
...
/**
 * @param {string} data
 * @returns {ParsedKittySequence | null}
 */
...
/**
 * @param {string} data
 * @returns {ParsedModifyOtherKeysSequence | null}
 */
...
/**
 * @param {string} keyId
 * @returns {{ key: string, ctrl: boolean, shift: boolean, alt: boolean, super: boolean } | null}
 */
 ...
 *
 * @param {string} data - Raw input data from terminal
...
export function matchesKey(data, keyId) {
	...
	switch (key) {
		...
		case "f12": {
			...
			const functionKey = /** @type {keyof typeof LEGACY_KEY_SEQUENCES} */ (key);
 ...
 *
 * @param {string} data - Raw input data from terminal
 * @returns {string | undefined} The printable character, or undefined if not a printable CSI-u sequence
 */
